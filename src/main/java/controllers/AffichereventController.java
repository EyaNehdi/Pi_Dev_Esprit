...
public class AffichereventController {
    ...
    void chercher(ActionEvent event) {
        ...
        try {
            ObservableList<event> formations = FXCollections.observableArrayList(servicesevent.readAll());
    ...
    void Supprimer_event(ActionEvent event) {
        try {
            event eventSelectionne = tv_event.getSelectionModel().getSelectedItem();

            if (eventSelectionne != null) {
                servicesevent ps = new servicesevent();
                ps.delete(eventSelectionne);
                initialize();
            } else {
    ...
    void initialize() {
        try {
            ...
            ObservableList<event> events = FXCollections.observableList(servicesevent.readAll());
    ...
    void Modifier_event(ActionEvent event) {
        ...
        Stage currentStage = (Stage) btn_modifier.getScene().getWindow();
        currentStage.close();
        if (selectedEvent != null) {
            ...
            controller.initData(selectedEvent.getId());

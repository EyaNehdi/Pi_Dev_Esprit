...
public class Afficherreservationcontroller {
        ...
        if (selectedReservation != null) {
            ...
            if (modificationConfirme) {
                try {
                    ...
                    servicesreservation.update(selectedReservation);

                    // Rafraîchir la TableView
                    ObservableList<reservation> reservations = FXCollections.observableList(servicesreservation.readAll());
   ...
   private boolean showModificationDialog(reservation selectedReservation) {
    ...
    void Supprimer_reservation(ActionEvent event) {
        ...
        try {
            servicesreservation.delete(selectedReservation);
